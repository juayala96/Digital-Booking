package com.example.demo.proyecto.controller.jwt;

import com.example.demo.proyecto.config.jwt.JwtProviderConfig;
import com.example.demo.proyecto.dto.JwtDTO;
...
public class AuthController {
     ...
     * */
    @PostMapping("/token")
    public ResponseEntity<Map<String, Object>> token(@RequestBody Usuario usuario) {
